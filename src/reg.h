...
#define WINDOWS_REGISTRY_PROTOCOL                    \
  {                                                  \
    0x6C977486, 0xB9EB, 0x475C, {                    \
      0xBC, 0xD4, 0x52, 0xD5, 0xDF, 0xB5, 0x63, 0x8F \
    }                                                \
  }
...
typedef EFI_STATUS(EFIAPI* EFI_REGISTRY_HIVE_CLOSE)(IN EFI_REGISTRY_HIVE* This);
