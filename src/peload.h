...
#define PE_LOADER_PROTOCOL                           \
  {                                                  \
    0xBA5A36D4, 0xC83C, 0x4D81, {                    \
      0xB1, 0x6E, 0xBF, 0x39, 0xF7, 0x40, 0xEA, 0x79 \
    }                                                \
  }
...
typedef EFI_STATUS(EFIAPI* EFI_PE_LOADER_LOAD)(IN EFI_FILE_HANDLE File,
                                               IN void*           BaseAddress,
...
typedef EFI_STATUS(EFIAPI* EFI_PE_IMAGE_FREE)(IN EFI_PE_IMAGE* This);

typedef EFI_STATUS(EFIAPI* EFI_PE_IMAGE_GET_ENTRY_POINT)(IN EFI_PE_IMAGE* This,
                                                         OUT void** EntryPoint);
...
typedef UINT32(EFIAPI* EFI_PE_IMAGE_GET_SIZE)(IN EFI_PE_IMAGE* This);

typedef EFI_STATUS(EFIAPI* EFI_PE_IMAGE_RESOLVE_FORWARD)(IN char*    Name,
                                                         OUT UINT64* Address);
...
typedef UINT32(EFIAPI* EFI_PE_IMAGE_GET_CHECKSUM)(IN EFI_PE_IMAGE* This);

typedef UINT16(EFIAPI* EFI_PE_IMAGE_GET_DLL_CHARACTERISTICS)(
    IN EFI_PE_IMAGE* This);

typedef EFI_STATUS(EFIAPI* EFI_PE_IMAGE_MOVE_ADDRESS)(IN EFI_PE_IMAGE* This,
                                                      IN EFI_PHYSICAL_ADDRESS
                                                          NewAddress);

typedef EFI_STATUS(EFIAPI* EFI_PE_IMAGE_GET_VERSION)(IN EFI_PE_IMAGE* This,
...
typedef UINT32(EFIAPI* EFI_PE_IMAGE_GET_CHARACTERISTICS)(IN EFI_PE_IMAGE* This);

typedef EFI_STATUS(EFIAPI* EFI_PE_IMAGE_SET_NO_RELOC)(IN EFI_PE_IMAGE* This);

typedef EFI_STATUS(EFIAPI* EFI_PE_IMAGE_RELOCATE)(IN EFI_PE_IMAGE* This,
                                                  IN EFI_VIRTUAL_ADDRESS
                                                      Address);
